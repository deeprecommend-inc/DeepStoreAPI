...
use crate::models::_entities::reservations::{ActiveModel, Entity, Model};
...
impl Params {
    fn update(&self, item: &mut ActiveModel) {
      item.reservation_date = Set(self.reservation_date.clone());
      item.arrival_date = Set(self.arrival_date.clone());
      item.location = Set(self.location.clone());
      item.store_name = Set(self.store_name.clone());
      item.send_to = Set(self.send_to.clone());
      }
}
